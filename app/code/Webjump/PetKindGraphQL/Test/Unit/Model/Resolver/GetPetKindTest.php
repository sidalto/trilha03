...
use Webjump\PetKindGraphQL\Model\Resolver\GetPetKind;

class GetPetKindTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function setUp(): void
    {
        ...
        $this->testSubject = new GetPetKind($this->petKindRepository);
    }
    ...
    public function testResolve()
    {
        ...
        $this->assertEquals($this->petKindInterface, $result);
    }
}
