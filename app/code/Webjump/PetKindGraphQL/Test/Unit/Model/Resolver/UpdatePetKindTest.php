...
use Webjump\PetKindGraphQL\Model\Resolver\UpdatePetKind;

class UpdatePetKindTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function setUp(): void
    {
        ...
        $this->testSubject = new UpdatePetKind($this->petKindInterface, $this->petKindRepository);
    }
